...
local ok_p, personal = pcall(require, "personal")
personal = ok_p and personal or {}
...
return {
  ...
  -- └────────────────────────────────────────────────────────────────────────┘
  {
    ...
    opts = {
      default_map = true,
      auto_update = true,
      user = (personal.header42 or {}).user or "your_login",
      mail = (personal.header42 or {}).mail or "your_login@student.42.fr",
      asciiart = {
        "        :::      ::::::::",
        "      :+:      :+:    :+:",
        "    +:+ +:+         +:+  ",
